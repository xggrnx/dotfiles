...
#Core packages
sudo apt-get install mc zsh git mercurial vim exuberant-ctags curl wget libcurl4-openssl-dev python3-pip
...
cp ~/src/dotfiles/pocahontas.zsh-theme ~/.oh-my-zsh/themes/
